...
export const FORM_SCHEMAS = {
  Upgrade: {title:'Upgrade Request', source:'Upgrade Request.pdf', fields:[
    ...
    plan('current_capacity','Current Plan'), plan('new_capacity','New Upgrade'),
  ...
  Downgrade: {title:'Downgrade Request', source:'Downgrade Request.pdf', fields:[
    ...
    plan('current_capacity','Original Plan'), plan('new_capacity','New Plan'),
  ...
  'Seasonal Upgrade': {title:'Seasonal Upgrade 21', source:'Seasonal Upgrade 21.pdf', fields:[
    ...
    plan('current_capacity','Current Plan'), plan('new_capacity','New Downgrade'),
  ...
  'On Hold': {title:'On Hold 20', source:'On Hold 20.pdf', fields:[
    ...
    plan('current_capacity','Original Plan'), price('mrr','MRR'), manager
  ]},
  ...
  Reconnection: {title:'Reconnection', fields:[client, field('customer_id','Customer ID'), date('Effective / Billing Date'),
    plan('new_capacity','New Capacity / Plan'), price('new_price','New Price'), field('reason','Reason'), comments]}
};
